...
A project is an administrative-level entity that is associated with an owner address, which is your [wallet address](/docs/register-as-user).

A project can have many [collections](/docs/register-collection).
