...
<Tabs>
  <TabItem value="core-sdk" label="Core SDK">
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Link SDK (with JS SDK) - deprecating soon</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
          <li>Using the <a href="https://github.com/starknet-community-libs/get-starknet">get-starknet</a> library</li>
        </ul>
      </td>
    </tr>
  </tbody>
