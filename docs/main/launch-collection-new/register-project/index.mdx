...
slug: "/launch-collection-new/register-project"
keywords: [imx-dx]
---

A project is an administrative-level entity that is associated with an owner address, which is your [wallet address](/docs/launch-collection-new/register-as-user).

A project can have many [collections](/docs/launch-collection-new/register-project).
...
### Steps:
1. [Register a project](#register-a-project)
2. [Get details about your projects](#get-details-about-your-projects)
