...
slug: "/launch-collection-new/register-as-user"
keywords: [imx-dx]
---
...
Please read [here](/docs/guides-new/user-registration) for more information on this process.

### Steps:
1. [Get an Ethereum (L1) wallet](#get-an-ethereum-l1-wallet)
...
The easiest way of registering as a user on Immutable X is to connect your wallet to the Immutable marketplace ([Ethereum](https://market.immutable.com/), [sandbox](https://market.sandbox.immutable.com/)).
...
2. Follow the steps in `1. Register as a user with Immutable X` [here](https://github.com/immutable/imx-examples/blob/main/docs/onboarding.md#1-register-as-a-user-with-immutable-x)