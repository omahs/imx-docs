...
## Link
To implement a burn feature for users on your frontend, you should use the `link.transfer` function with the recipient set as the burn address. [Learn more.](https://docs.x.immutable.com/docs/linktransfer) 
